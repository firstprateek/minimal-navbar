 ...
 */
var HamburgerButton = /*#__PURE__*/function (_LitElement) {
  _inherits(HamburgerButton, _LitElement);
  var _super = _createSuper(HamburgerButton);
...
_defineProperty(HamburgerButton, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        button {\n            background-color: transparent;\n            border: none;\n            cursor: pointer;\n        }\n        div {\n            background-color: var(--hamburger-stripe-color, #58595B);\n            width: 35px;\n            height: 5px;\n            margin: 6px 0;\n            border-radius: 4px;\n            transition: 0.4s;\n        }\n        .change div:nth-child(1) {\n            -webkit-transform: rotate(-45deg) translate(-8px, 6px);\n            transform: rotate(-45deg) translate(-8px, 6px);\n        }\n        .change div:nth-child(2) {\n            opacity: 0;\n        }\n        .change div:nth-child(3) {\n            -webkit-transform: rotate(45deg) translate(-9px, -8px);\n            transform: rotate(45deg) translate(-9px, -8px);\n        }\n    "]))));
_defineProperty(HamburgerButton, "properties", {
  hidden: {
    reflect: true,
    type: Boolean
  },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MinimalNavbar: () => (/* binding */ MinimalNavbar)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit */ "./node_modules/lit/index.js");
...
/* harmony import */ var _hamburger_btn_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hamburger-btn.js */ "./src/hamburger-btn.js");
...
var MinimalNavbar = /*#__PURE__*/function (_LitElement) {
  _inherits(MinimalNavbar, _LitElement);
  var _super = _createSuper(MinimalNavbar);
  function MinimalNavbar() {
    var _this;
    _classCallCheck(this, MinimalNavbar);
    _this = _super.call(this);
    // Event handlers
    _defineProperty(_assertThisInitialized(_this), "windowSizeChangeHandler", function () {
      _this.isMobile = window.innerWidth <= _this.breakpoint;
    });
    _defineProperty(_assertThisInitialized(_this), "handleLinkClick", function (e) {
      if (e.target.tagName !== 'A') {
        return;
      }
      _this.activeLink = e.target.textContent.toLowerCase().trim();
      _this.drawerOpen = false;
      var options = {
        detail: {
          active: _this.activeLink
        },
        bubbles: true,
        composed: true
      };
      _this.dispatchEvent(new CustomEvent('activeLinkChanged', options));
    });
    _this.breakpoint = 500;
    _this.brandPlacement = 'left';
    _this.isMobile = false;
    _this.drawerOpen = false;
    _this.activeLink = '';
    return _this;
  }
  _createClass(MinimalNavbar, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _get(_getPrototypeOf(MinimalNavbar.prototype), "connectedCallback", this).call(this);
    ...
    value: function disconnectedCallback() {
      _get(_getPrototypeOf(MinimalNavbar.prototype), "disconnectedCallback", this).call(this);
    ...
    value: function updated() {
      ...
      if (this.nav) {
        if (this.isMobile) {
          ...
          this.nav.style.transform = "translateY(".concat(navYdistance, ") translateX(").concat(navXdistance, "%)");
          setTimeout(function () {
            _this2.nav.classList.add('animate');
          }, 0);
        } else {
          this.nav.style.transform = "translateY(".concat(navYdistance, "px)");
          this.nav.classList.remove('animate');
        }
      }
      if (this.links) {
        this.links.forEach(function (link) {
          if (link.textContent.toLowerCase().trim() === _this2.activeLink) {
    ...
    key: "brandTemplate",
    value: function brandTemplate() {
      var _this3 = this;
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div>\n        <slot name=\"brand\" class=\"logo\"></slot>\n        <hamburger-btn \n          ?hidden=", "\n          @click=", "\n        >\n        </hamburger-btn>\n      </div>"])), !this.isMobile, function () {
        return _this3.drawerOpen = !_this3.drawerOpen;
      });
    }
  }, {
    key: "navTemplate",
    value: function navTemplate() {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <nav \n        class=", " \n        @click=", "\n      >\n        <slot name=\"link\"></slot>\n      </nav>\n    "])), (0,lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_1__.classMap)({
        show: this.isMobile && this.drawerOpen
      }), this.handleLinkClick);
    }
  }, {
    key: "render",
    value: function render() {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      <header class=", ">\n        ", "\n        ", "\n        ", "              \n      </header>\n    "])), this.isMobile && 'mobile', this.brandPlacement === 'left' ? this.brandTemplate() : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral([""]))), this.navTemplate(), this.brandPlacement === 'right' ? this.brandTemplate() : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([""]))));
    }
  }, {
    key: "header",
    get:
    ...
    function get() {
      ...
      return (_this$renderRoot$quer = (_this$renderRoot = this.renderRoot) === null || _this$renderRoot === void 0 ? void 0 : _this$renderRoot.querySelector('header')) !== null && _this$renderRoot$quer !== void 0 ? _this$renderRoot$quer : null;
    }
  }, {
    key: "div",
    get: function get() {
      var _this$header$querySel, _this$header;
      return (_this$header$querySel = (_this$header = this.header) === null || _this$header === void 0 ? void 0 : _this$header.querySelector('div')) !== null && _this$header$querySel !== void 0 ? _this$header$querySel : null;
    }
  }, {
    key: "button",
    get: function get() {
      var _this$header$querySel2, _this$header2;
      return (_this$header$querySel2 = (_this$header2 = this.header) === null || _this$header2 === void 0 ? void 0 : _this$header2.querySelector('hamburger-btn')) !== null && _this$header$querySel2 !== void 0 ? _this$header$querySel2 : null;
    }
  }, {
    key: "nav",
    get: function get() {
      var _this$header$querySel3, _this$header3;
      return (_this$header$querySel3 = (_this$header3 = this.header) === null || _this$header3 === void 0 ? void 0 : _this$header3.querySelector('nav')) !== null && _this$header$querySel3 !== void 0 ? _this$header$querySel3 : null;
    }
  }, {
    key: "links",
    get: function get() {
      var _this$renderRoot2;
      var linkSlot = (_this$renderRoot2 = this.renderRoot) === null || _this$renderRoot2 === void 0 ? void 0 : _this$renderRoot2.querySelector('slot[name="link"]');
      return linkSlot.assignedElements();
    }
  }, {
    key: "headerHeight",
    get: function get() {
      var _this$header4, _this$header4$getBoun;
      return "".concat((((_this$header4 = this.header) === null || _this$header4 === void 0 ? void 0 : (_this$header4$getBoun = _this$header4.getBoundingClientRect()) === null || _this$header4$getBoun === void 0 ? void 0 : _this$header4$getBoun.height) || 75) + 2, "px");
    }
  }]);
  return MinimalNavbar;
}(lit__WEBPACK_IMPORTED_MODULE_0__.LitElement);
_defineProperty(MinimalNavbar, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    * {\n      box-sizing: border-box;\n    }\n\n    :host {\n      width: 100%;\n      position: relative;\n      display: block;\n      top: 0;\n      z-index: 99;\n      box-shadow: var(--navbar-shadow, 0 1px 2px rgb(0 0 0 / 50%));\n      height: var(--navbar-height, 75px);\n      font-size: var(--navbar-font-size, 16px);\n      font-family: var(--navbar-font-family, \"Exo 2\", sans-serif);\n    }\n\n    header {\n      height: 100%;\n      width: 100%;\n      display: grid;\n      grid-template-rows: 100%;\n      grid-template-columns: 1fr auto;\n    }\n\n    header:not(.mobile) {\n      overflow: hidden;\n    }\n\n    header div {\n      width: 100%;\n      z-index: 99;\n      display: grid;\n      grid-template-rows: 100%;\n      grid-template-columns: auto auto;\n      align-items: center;\n      justify-content: space-between;\n      padding: 0 1rem;\n      background-color: var(--navbar-bg-color, #FFFFFF);\n    }\n\n    header nav {\n      width: 100%;\n      position: absolute;\n      display: grid;\n      padding: 1rem 0;\n      background-color: var(--navbar-menu-color, #FFFFFF);\n    }\n\n    header:has(nav.show) {\n      box-shadow: none;\n    }\n\n    header.mobile nav {\n      display: grid;\n      grid-auto-rows: 100px;\n      padding: 0;\n      height: calc(100vh - var(--navbar-height, 75px));\n    }\n\n    header.mobile nav.show {\n      box-shadow: 0 1rem 3rem rgba(0,0,0,0.175);\n    }\n\n    header:not(.mobile) nav {\n      align-items: center;\n      grid-auto-flow: column;\n      justify-content: flex-end;\n      padding: 0 0.5rem 0 0;\n      position: relative;\n      z-index: unset;\n    }\n    header:not(.mobile) nav a {\n      padding: 0 1rem;\n    }\n\n    ::slotted(a) {\n      color: var(--navbar-link-color, #58595B);\n      padding: 0 0.5rem;\n      text-decoration: none;\n      -webkit-tap-highlight-color: rgba(0, 0, 0, 0) !important;\n      height: 100%;\n      box-sizing: border-box;\n      display: flex;\n      align-items: center;\n      cursor: pointer;\n    }\n\n    ::slotted(a:hover) {\n      opacity: 0.75;\n    }\n\n    ::slotted(a.active.isMobile) {\n      border-left: 2px solid var(--navbar-highlight-color, #E65446);\n    }\n\n    ::slotted(a.isMobile) {\n      border-left: 2px solid transparent;\n    }\n\n    ::slotted(a.active:not(.isMobile)) {\n      border-bottom: 2px solid var(--navbar-highlight-color, #E65446);\n      border-top: 2px solid transparent;\n    }\n\n    .logo::slotted(a) {\n      color: var(--navbar-highlight-color, #E65446);\n      font-size: 2em;\n      max-height: 100px;\n      padding: 0;\n      text-decoration: none;\n      cursor: default;\n      user-select: none;\n    }\n\n    .logo::slotted(a:hover) {\n        opacity: 1;\n    }\n\n    .logo::slotted(a:hover) {\n      color: var(--navbar-highlight-color, #E65446);\n    }\n\n    .animate {\n      transition: all 0.4s ease-in-out !important;\n    }\n\n    ::slotted(.nav-link--active) {\n      color: var(--navbar-link-active-color, #333333) !important;\n    }\n"]))));
_defineProperty(MinimalNavbar, "properties", {
  breakpoint: {
    type: Number
  },
  brandPlacement: {
...
/******/ })()
;
//# sourceMappingURL=bundlefd81b8f080ab4f3ed074.js.map